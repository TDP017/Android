...
//	public byte[] decryptData(byte[] data, SecretKey sk, IvParameterSpec iv, Cipher c) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
//		c.init(Cipher.DECRYPT_MODE, sk, iv);
//		byte[] bytes = c.doFinal(data);
//		return bytes;
//	}
